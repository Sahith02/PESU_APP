...
UPDATE `pesuapp`.`announcement` SET `title` = 'From the VC\'s desk - Bulletin #19, March 12, 2021', `location` = '', `description` = 'From the VC\'s desk', `picture_link` = 'http://tiny.cc/97gvtz', `hyperlink` = '' WHERE (`id` = '3');
UPDATE `pesuapp`.`announcement` SET `title` = 'ESA March-April 2021 Time Table for BBAHEM 6th sem', `location` = '', `description` = 'ESA March-April 2021 Time Table for BBAHEM 6th sem', `picture_link` = 'https://cdn1.vectorstock.com/i/1000x1000/53/10/school-timetable-icon-vector-13465310.jpg', `hyperlink` = 'https://www3.nd.edu/~pkamat/pdf/researchpaper.pdf' WHERE (`id` = '2');
UPDATE `pesuapp`.`announcement` SET `title` = 'Kindly note a student registering for Special ESA ', `location` = 'MRD', `description` = 'Kindly note a student registering for Special ESA / Backlog Course can take a maximum of 20 credits in May 2021 ESA. This limit includes both Special ESA + Backlog Course. For Example: If a student has registered for 8 credits in backlog he/she can take a maximum of 12 credits in Special ESA.', `picture_link` = 'https://leverageedu.com/blog/wp-content/uploads/2019/08/Course-after-MBA.png', `hyperlink` = 'https://www3.nd.edu/~pkamat/pdf/researchpaper.pdf' WHERE (`id` = '1');
